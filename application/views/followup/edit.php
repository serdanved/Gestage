    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Followup Edit</h3>
            </div>
			<?php echo form_open('followup/edit/'.$followup['ID']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="INTERNSHIP_ID" class="form-control">
								...
								{
									$selected = ($internship['ID'] == $followup['INTERNSHIP_ID']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="CREATOR_ID" class="form-control">
								...
								{
									$selected = ($value == $followup['CREATOR_ID']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="CREATOR_TYPE" class="form-control">
								...
								{
									$selected = ($creator_type['ID'] == $followup['CREATOR_TYPE']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="DESCRIPTION" class="form-control" id="DESCRIPTION"><?php echo ($this->input->post('DESCRIPTION') ? $this->input->post('DESCRIPTION') : $followup['DESCRIPTION']); ?></textarea>
						</div>
					</div>
				</div>
			</div>
