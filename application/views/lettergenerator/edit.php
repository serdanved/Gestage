<div class="row">
    <div class="col-md-12">
      	<div class="panel panel-primary">
            ...
            <?php echo form_open('lettergenerator/edit/'.$lettergenerator['ID']); ?>
          	<div class="panel-body">
          		<div class="row clearfix">
					<div class="col-md-4">
						<label for="NAME" class="control-label">Nom</label>
						<div class="form-group">
	                        <input type="text" name="NAME" value="<?php echo $lettergenerator['NAME']; ?>" class="form-control" id="NAME" />
						</div>
					</div>
					<div class="col-md-4">
