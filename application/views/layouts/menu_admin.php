<li>
    <a href="<?= site_url('user/admin_index') ?>">
        <i class="fa fa-list-ul" style="margin-left: 4px"></i> <span>ADMINISTRATEURS</span>
    </a>
</li>
<li>
    <a href="<?= site_url('employer/index') ?>">
        <i class="fa fa-building" style="margin-left: 4px"></i> <span>GESTION EMPLOYEURS</span>
    </a>
</li>
<li>
    <a href="<?= site_url("/employer/catindex"); ?>">
        <i class="fa fa-list-ul" style="margin-left: 4px"></i> <span>CATÉGORIES EMPLOYEURS</span>
    </a>
</li>
<li>
