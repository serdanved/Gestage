            ...
            <div class="panel-heading with-border">
          	...
          	<div class="panel-body">
          		<div class="row clearfix">
                    ...
                    <div class="col-md-12">
                        <?php if($obligation != NULL): ?>
                        <div data-builder-json='<?php echo $obligation['FORM_DATA'];?>' id="fb-render"></div>
                        <?php endif; ?>
                        
                        <?php if($obligation === NULL): ?>
                        <div data-builder-json='<?php echo $form['DATA'];?>' id="fb-render"></div>
                        <?php endif; ?>
                    </div>
             ...
             <?php if($obligation != NULL): ?>
          	<div class="box-footer">
            	<button id="formrender-submit" type="button" class="btn btn-success">
...
<style>
.formbuilder-signature,.formbuilder-signature_enseignant,.formbuilder-signature_employeur{display:none;}
