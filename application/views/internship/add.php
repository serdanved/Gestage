<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
            ...
            <?php echo form_open('internship/add'); ?>
          	<div class="box-body">
				<div class="col-md-6">
						...
						<div class="panel-body">
							<div class="col-md-12">
								...
								<div class="form-group">
									<select name="PROGRAM_ID" class="form-control program_select_change">
							...
							<div class="col-md-12">
								...
								<div class="form-group">
									<select name="STUDENT_ID[]" class="form-control" multiple>
										...
										{
											$selected = ($student['ID'] == $this->input->post('STUDENT_ID')) ? ' selected="selected"' : "";
						...
						<div class="panel-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group input-group col-md-12" >
                                    <input  id="BLOCK_NAME"  name="BLOCK_NAME" value="<?php echo $this->input->post('BLOCK_NAME'); ?>" class="form-control">
                                </div> 
                            </div>
                            ...
                            <div class="form-group input-group col-md-12" >
                                <input id="TOTAL_HOURS"  name="TOTAL_HOURS" value="<?php echo $this->input->post('TOTAL_HOURS'); ?>" class="form-control">
                            </div> 
                        </div>
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<input type="text" name="DATE_START" value="<?php echo $this->input->post('DATE_START'); ?>" class="has-datepicker form-control" data-date-format="YYYY-MM-DD" id="DATE_START" />
								</div>
							</div>
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<input type="text" name="DATE_END" value="<?php echo $this->input->post('DATE_END'); ?>" class="has-datepicker form-control" data-date-format="YYYY-MM-DD" id="DATE_END" />
								</div>
							</div>
						</div>
					</div>
