...
class Internship_model extends CI_Model {
	...
	function get_internship($ID) {
		$this->db->select("Inter.ID AS ID,Inter.EMPLOYER_CONTACT_ID AS EMPLOYER_CONTACT_ID, Blo.TEACHER_ID AS TEACHER_ID,Inter.SCHEDULE AS SCHEDULE, Inter.DATE_START AS DATE_START,Inter.DATE_END AS DATE_END,Inter.DESCRIPTION AS DESCRIPTION,Inter.STUDENT_ID AS STUDENT_ID,Inter.EMPLOYER_ID AS EMPLOYER_ID, IF(Inter.DATE_END < now(),'FINISHED',IF(Inter.DATE_START > now(),'FUTUR','CURRENT')) AS INTERNSHIP_STATUS, Stu.NAME AS STUDENT_NAME,Stu.SCHOOL AS SCHOOL, Emp.CONTACT_NAME AS EMPLOYER_CONTACT, Emp.EMPLOYER_NAME AS EMPLOYER_NAME, Pro.NAME AS PROGRAM_NAME, Pro.ID AS PROGRAM_ID, Emp.ID AS EMPLOYER_ID, Stu.ID AS STUDENT_ID");
